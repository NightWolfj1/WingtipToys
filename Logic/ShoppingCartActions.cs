...
using System.Linq;
using System.Web;
using WingtipToyss.Models;

namespace WingtipToyss.Logic
{
    public class ShoppingCartActions : IDisposable
    {
        ...
        {
            ShoppingCartId = GetCartId();
            // Multiplique el precio del producto por la cantidad de ese producto para obtener 
            // el precio actual de cada uno de esos productos en el carrito.
            // Suma todos los precios totales de los productos para obtener el total del carrito.
       ...
       CartItemUpdates)
        {
            using (var db = new WingtipToyss.Models.ProductContext())
            {
                try
                {
        ...
        {
            using (var _db = new WingtipToyss.Models.ProductContext())
            {
                try
                {
